<section id="main-content">
    ...
    <a href="http://localhost/ttcn/index.php?task=form_menu"><button type="button" class="btn btn-primary btn-sm">Danh sách</button></a>
        ...
        <div class="">
            <!-- Form -->
            <form enctype="multipart/form-data" method="post" action="index.php?task=capnhat&id=<?php echo $_GET['id']; ?>" id="form" class="form">
                <fieldset>
                    <div class="widget">
                        <div class="row">
                        </div>
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table table-bordered" id="checkAll">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="formRight">
                                            <input value="<?php if(!isset($_POST['link'])){ echo $row['url'];} echo isset($_POST['link']) ? $_POST['link'] :'' ?>" type="text" class="form-control" _autocheck="true" id="param_link" name="link">
                                        </div>
                                    </td>
                                </tr>
